...
を正とする**——**ここに率を書かない**。一度「約 1.8 倍」と書いて、**2 行下でリンクしている
先が「1.7 倍」**という状態になった（#95 の 4 パス目）。
