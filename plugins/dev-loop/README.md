...
> ほぼ全部持っており、規範を 1 つ足すたびに**ここと `SKILL.md` と設計ドキュメントの 3 箇所を
> 揃え直していた**。#92 では**同じ数え上げを 6 回外し**、レビューが 2 パス連続で 13 件を返して
> 収束しなかった。規範を減らしたのではなく、**規範の住所を 1 つにした**（[#94](https://github.com/hdknr/claude-code-setup/issues/94)）。
