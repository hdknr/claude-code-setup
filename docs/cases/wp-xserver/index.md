...
| [6](06-ssh-setup.md) | SSH 接続を設定する | xserver に SSH でつなげる状態を作れる |
| [7](07-xserver-to-github.md) | xserver の内容を GitHub に取り込む | 現状の WordPress 一式を GitHub に登録できる |
| [8](08-stage-docker.md) | Docker で stage 環境 | ローカル PC に WordPress の動作確認用環境を作れる |
| [9](09-edit-and-pr.md) | 修正と PR | stage で確認 → GitHub に PR を出せる |
| [10](10-deploy-xserver.md) | xserver にデプロイ | SSH または WP REST API で本番に反映できる |
| [11](11-troubleshooting.md) | トラブルシュート | よく詰まる箇所と回避法が分かる |
